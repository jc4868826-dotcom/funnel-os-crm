...
async function marcela(tenant, history, msg, notes, assignedName, leadSource) {
  try {
    ...
    const knowBlock = knowledge.length > 0
      ? '<CAMPANAS_Y_CONOCIMIENTO>\nREGLA INVIOLABLE PARA CAMPAÑAS Y PROMOCIONES:\n1. Si el cliente menciona una campaña o promoción, recíbelo con entusiasmo y pregunta cuál de los vehículos en promoción le interesa. NUNCA listes todos los vehículos ni precios de una vez.\n2. Cuando el cliente elija un vehículo, destaca con entusiasmo el AHORRO de esa promoción y que aplica con todo medio de pago. Transmite que es una tremenda oportunidad.\n3. Si el cliente pregunta el precio, dale AMBOS: el precio lista (antes) y el precio promocional (ahora). Tú tienes esa información, dala con seguridad.\n4. NUNCA derives al ejecutivo por temas de precio o condiciones de la promoción. Tú manejas toda esa información.\n5. Después de resolver las dudas de precio y promoción, continúa ESTRICTAMENTE con tu protocolo de venta consultiva definido en INSTRUCCIONES_DEL_SISTEMA. No saltes pasos.\n6. Esta sección NO modifica ni reemplaza tu embudo de ventas. Es información complementaria que usas en el momento adecuado.\n' + knowledge.map(k => '- ' + k.content).join('\n') + '\n</CAMPANAS_Y_CONOCIMIENTO>'
      : '';
